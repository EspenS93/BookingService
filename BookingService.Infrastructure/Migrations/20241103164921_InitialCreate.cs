        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxInfants = table.Column<int>(type: "integer", nullable: true),
                    MaxTotalOccupants = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoomDetailId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalCostPaid = table.Column<double>(type: "double precision", nullable: false),
                    TotalCostDue = table.Column<double>(type: "double precision", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationDetails", x => x.ReservationId);
                    table.ForeignKey(
                        name: "FK_ReservationDetails_RoomDetails_RoomId",
                        column: x => x.RoomId,
                        principalTable: "RoomDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoomFacility_RoomDetails_RoomDetailId",
                        column: x => x.RoomDetailId,
                        principalTable: "RoomDetails",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoomFeature_RoomDetails_RoomDetailId",
                        column: x => x.RoomDetailId,
                        principalTable: "RoomDetails",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomFacility_RoomDetailId",
                table: "RoomFacility",
                column: "RoomDetailId");

            migrationBuilder.CreateIndex(
                name: "IX_RoomFeature_RoomDetailId",
                table: "RoomFeature",
                column: "RoomDetailId");
        }
